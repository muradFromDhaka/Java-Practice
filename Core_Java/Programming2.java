public class Programming2 {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("\n8.Bitwise Operators");
        int bi = 5 , bi1 = 3;
        System.out.println("bi & bi1: " + (bi & bi1)); // AND
        System.out.println("bi | bi1: " + (bi | bi1)); // OR
        System.out.println("bi ^ bi1: " + (bi ^ bi1)); // XOR
        System.out.println("~bi: " + (~bi)); // Complement
        System.out.println("bi << 1: " + (bi << 1)); // Left Shift
        System.out.println("bi >> 1: " + (bi >> 1)); // Right Shift
        System.out.println("bi >>> 1: " + (bi >>> 1)); // Unsigned right Shift
